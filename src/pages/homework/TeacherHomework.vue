              ...
              <div v-if="item.end_flag !== 0" style="display: flex; flex-direction: column">
                ...
                >
                  ...
                  <vxe-column title="操作" width="160px">
                    <template #default="{ row }">
                      <div>
                        <t-button theme="primary" variant="text" size="small" @click="pushToOneStuRate(row)">
                          查看
                        </t-button>
                      </div>
                    </template>
              ...
              <div v-else style="display: flex; flex-direction: column; margin-left: 20px; margin-top: 20px">
                ...
                <div style="display: flow">
                  <t-form>
                    ...
                    <t-form-item v-if="rateEachCheckBox" label="互评任务量">
...
const pushToOneStuRate = function (row) {
  console.log(row)
  router.push({
    ...
    params: {
      ...
      teacherHomeworkId: headerMenuHomeworkSelect.value,
    },
  })
}
